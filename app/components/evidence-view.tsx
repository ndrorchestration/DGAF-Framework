...
export function EvidenceView() {
  return <div className="view-stack">
    ...
    <section className="claim-ceiling panel panel-accent"><div><span className="eyebrow accent">CURRENT CLAIM CEILING</span><h3>Canonical DGAF efficacy is {TRUTH_BOUNDARY.efficacy}.</h3><p>Epoch 001 cannot support its planned primary inference because the protected mapping is unrecoverable. Epoch 002 collection completed, but retained-byte admission, dataset lock, unblinding, and primary analysis remain separate unresolved transitions.</p></div><StatusChip state="not_established" label="EFFICACY NOT ESTABLISHED"/></section>
