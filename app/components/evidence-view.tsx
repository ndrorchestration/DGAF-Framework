...
export function EvidenceView() {
  return <div className="view-stack">
    ...
    <section className="claim-ceiling panel panel-accent evidence-ceiling"><div><span className="eyebrow accent">CURRENT CLAIM CEILING</span><h3>Canonical DGAF efficacy is {TRUTH_BOUNDARY.efficacy}.</h3><p>Epoch 001 cannot support the planned primary inference because the protected mapping is unrecoverable. Epoch 002 has not been authorized for empirical collection. Engineering readiness does not bridge either gap.</p></div><StatusChip state="not_established" label="EFFICACY NOT ESTABLISHED"/></section>

    <section className="evidence-lineage panel" aria-labelledby="evidence-lineage-title">
      <div className="evidence-lineage-heading"><div><span className="eyebrow">CURRENT EVIDENCE LINEAGE</span><h3 id="evidence-lineage-title">What is established, what is open, and what remains prohibited</h3></div><p>These are separate epistemic and governance objects. Movement at one layer does not silently promote the next.</p></div>
      <div className="evidence-lineage-rail">
        <article className="evidence-current-node" data-kind="evidence"><span className="evidence-current-index">01</span><span className="eyebrow">LOCAL EVIDENCE</span><h4>Recovery evidence exists at a bounded level.</h4><p>{NEXT_TRANSITION.evidence}</p><StatusChip state="open" label="SELF-ATTESTED / NONINDEPENDENT" compact/></article>
        <div className="evidence-lineage-link" aria-hidden="true"><span /></div>
        <article className="evidence-current-node" data-kind="predicate"><span className="evidence-current-index">02</span><span className="eyebrow">REPOSITORY PREDICATE</span><h4>Custody acceptance remains open.</h4><p>{NEXT_TRANSITION.blocker}</p><StatusChip state="not_established" label="NOT ESTABLISHED" compact/></article>
        <div className="evidence-lineage-link" aria-hidden="true"><span /></div>
        <article className="evidence-current-node" data-kind="authority"><span className="evidence-current-index">03</span><span className="eyebrow">PERMISSION</span><h4>Successor collection remains prohibited.</h4><p>No downstream implementation or prepared validator grants collection authority.</p><StatusChip state="not_authorized" label={TRUTH_BOUNDARY.authorization} compact/></article>
        <div className="evidence-lineage-link" aria-hidden="true"><span /></div>
