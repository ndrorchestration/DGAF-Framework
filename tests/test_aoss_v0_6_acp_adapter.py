...
from scripts.aoss_v0_6_acp_adapter import AdapterError, classify_manifest, normalize_manifest
...
def test_freeze_parent_and_source_identity_are_exact() -> None:
    assert MANIFEST["freeze_parent"]["commit"] == "14cd93cc2a217ebe063a829ae246641a539e7fb3"
