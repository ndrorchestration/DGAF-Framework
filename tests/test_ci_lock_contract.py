...
TRACK_A_EPOCH_002_DATASET_LOCK_WORKFLOW = ROOT / ".github" / "workflows" / "track-a-epoch-002-dataset-lock.yml"
...
def test_epoch002_dataset_lock_uses_bound_lock_and_accepted_state_route() -> None:
    workflow = TRACK_A_EPOCH_002_DATASET_LOCK_WORKFLOW.read_text(encoding="utf-8")
    assert "runs-on: ubuntu-24.04" in workflow
    assert "python-version: '3.12.0'" in workflow
    assert "actions/checkout@3d3c42e5aac5ba805825da76410c181273ba90b1" in workflow
    assert "actions/setup-python@a309ff8b426b58ec0e2a45f0f869d46889d02405" in workflow
    ...
    assert "python scripts/validate_track_a_epoch_002_dataset_lock.py --accepted-state" in workflow
