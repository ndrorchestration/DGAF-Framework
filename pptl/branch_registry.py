...
from .state_identity import state_id
...
class BranchRegistry:
    """Retains every branch result, including rejected, correlated, and vetoing work."""
    ...
    def has_state(self, state: dict) -> bool:
        return state_id(state) in self._states
