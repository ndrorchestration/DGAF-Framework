...
- `python -m pytest tests -k capability -q`: **139 passed, 1 skipped**
...
1. multi-process crash recovery plus stale-reservation ownership/lease semantics for the SQLite-backed reference ledger;
2. stronger concurrency/interleaving and distributed-storage models;
