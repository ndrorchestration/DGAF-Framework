...
| Commercialization | Asset governance | `docs/governance/boundaries/DGAF_COMMERCIALIZATION_OPENNESS_BOUNDARY.md` | Commercial value ≠ technical validity |
| Trademark/certification | Legal/brand governance | `docs/governance/boundaries/DGAF_TRADEMARK_AND_CERTIFICATION_POLICY.md` | Certification ≠ universal guarantee |
