...
**Status:** DRAFT / PREDECLARATION / NONCANONICAL / NO NUMERIC W  
**Issues:** #287, #293, #296, #297  
**Base stack:** draft #299 on #294/#292  
**Scientific boundary:** PRE-FREEZE · FAIL-CLOSED · NOT AUTHORIZED · empirical N=0.

## Why this correction exists

Expert-panel review found a material scope mismatch in the current synthetic timing evidence.
...
Current draft `mode_t_timing_study.py` instead times one 180-trial seed-shaped matrix per repetition. Artifact `9980134764` correctly records `trials_per_repetition=180`; its samples are therefore valid bounded one-seed engineering timings, not complete-pilot timing evidence.
...
The current component lanes also do not yet establish one contiguous monotonic timing interval from the authorization-consumption-equivalent boundary through independently verified analysis lock.
...
Existing #294/#297 timing artifacts are **not discarded**. Their interpretation is narrowed:
...
No prior timing artifact may be relabeled as complete-pilot or W-eligible evidence.
...
## Anti-hallucination / drift rules

Future documentation and automation must not say that:

- 180 trials represent the complete 50-seed pilot;
- artifact `9980134764` measured the complete pilot;
- #297 established durable custody or full blinded-artifact retention timing;
...
This correction is engineering design only. Even a successful full-boundary timing study cannot by itself establish Mode-T custody sufficiency. The separate load-bearing custody/control-separation premise in #287 remains OPEN/UNKNOWN until independently accepted.

Only after Mode T is admitted, full-boundary timing is accepted, W is independently reviewed and frozen, repository enforcement is reconciled, canonical P4/P7/P8/P9 migration is reviewed, and the freeze/verification/authorization sequence completes may empirical execution occur.
