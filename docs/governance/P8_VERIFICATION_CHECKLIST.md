...
**Latest controlled completion candidate:** `a43219b4ed91fff8615f6c655ab3d17ca871fc29` / branch `completion/2026-09-01-exact-candidate`  
**Active P-35 remediation:** PR #188 / head `d83ea74c0f7ef7dd3e39a25345d6b201770a370c` / engineering-only  
**Historical experimental verification boundary:** `ac8ea267a9f0d995626cf9c3eaf9e6b008b5dc8a`  
**Prior completion candidate:** `562753b3053b3566b0fcad1b0b1df151d7de119a` (historical/superseded)
...
- [x] Current mainline runtime candidate `92ff830b…` is explicitly distinguished from the latest controlled completion candidate `a43219b…`.
...
- [x] Exact candidate identity verified for controlled completion candidate `a43219b…` — run `33572123857`.
- [x] Independent canonicalization path (`jq -S -c` + `sha256sum`) matched the DGAF/Python digest — run `33572123857`.
- [x] Authority identity regression passed against exact candidate `a43219b…` — run `33572123857`.
- [x] Independent P9 evidence artifact uploaded — artifact `9825660346`.
...
**Current state:** `P8 OPEN / FAIL-CLOSED`; P9 has a scoped PASS on controlled completion candidate `a43219b…`, while broader P9 closure remains open; no new freeze; no authorization; empirical N = 0.

> **Historical-state rule:** This checklist is a living control document. Older candidate SHAs may remain only when explicitly labeled historical/superseded. A document must never use an older candidate as its unqualified “latest” or “current” identity.
