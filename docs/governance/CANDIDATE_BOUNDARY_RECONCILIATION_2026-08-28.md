...
**Current `main`:** governed separately as living implementation/documentation lineage
**Freeze:** NOT CREATED
...
The following files were directly observed on the exact experimental candidate `ac8ea267…`:
...
| Protocol | `docs/experiment/PDMAL_EXPERIMENT_PROTOCOL.md` | `0923010a1b601290f10699a961a5231576430258` |
...
READY deployment `dpl_DND15HJ45s1d5eFcGmVr4SWNpGaC` is source-bound to `ac8ea267…`. Its readiness and health status are deployment evidence only. P2/P6a require authenticated matrices against the same exact candidate/deployment identity.

## Scientific binding

The adopted target is `dgaf` versus `null`, with FFCR as the primary endpoint, paired by root seed, equal-weight mean paired seed effect, two-sided 95% percentile paired bootstrap, 10,000 resamples, bootstrap seed `20260823`, and alpha `0.05`. Exact freeze binding remains open.
...
- This reconciliation is not a freeze manifest.
- It does not authorize execution or unblinding.
- It does not upgrade historical evidence to current evidence.
- It does not create empirical observations.
- It does not establish P2/P6a, P3–P6, P8, or P9 closure.
