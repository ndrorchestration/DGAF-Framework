...
> **Current boundary:** `main` is currently `02e4c958e435f1faaa6fbf15909f9141ed2a6e39`, the verified merge of PR #160. PR #160 restored P-31 SCPE and P-33 Convergence historical substrate with parity tests. This is an apparatus change and therefore defines the current post-restore candidate boundary. PR #162 is a separate draft provenance-binding change based on this commit; it is not merged and does not redefine `main`.
>
...
- `02e4c958e435f1faaa6fbf15909f9141ed2a6e39` — current `main` apparatus source after PR #160 P-31/P-33 restoration.
- PR #162 head `cdb63ca138cf6a60727f91067fe8f7338f19f4a6` — unmerged draft provenance-binding candidate; not current `main`.
...
|---|---|---|
| Current `main` | CURRENT APPARATUS + DOCUMENTATION LINEAGE | `02e4c958…`; resolve `main` directly for latest repository state |
...
| Post-#151 apparatus candidate | HISTORICAL / SUPERSEDED BY P-31/P-33 RESTORE | `05fa286…`; prior candidate boundary |
| **Current post-#160 apparatus candidate** | **DESIGNATED / NOT FROZEN** | `02e4c958…`; P-31/P-33 restored; remaining gates are incomplete |
| PR #162 provenance-binding change | DRAFT / NOT MERGED | head `cdb63ca…`; 31 successful checks and Live Regression (Vercel) skipped, per current PR status |
...
| DemiJoule | OPEN / FAIL-CLOSED | Constitutive contract unresolved: SPEC efficiency advisory vs implemented 6-axis semantic safety gate |
| P2 runtime verification | NEW CANDIDATE OPEN | Prior run `33300481208` remains exact to `303f4424…`; fresh execution required for current candidate |
| P6a CORS verification | NEW CANDIDATE OPEN | Prior run `33302495240` remains exact to `303f4424…`; fresh execution required for current candidate |
