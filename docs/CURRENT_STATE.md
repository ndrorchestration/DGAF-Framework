...
The separate `ndrorchestration/agent-control-plane` repository remains an external reference/integration asset rather than an implicit dependency. Its overlapping lifecycle/dispatch/policy/provenance concepts require explicit canonical ownership before synchronization is claimed.
