...
**Last Updated:** 2026-06-29 (Phase 4 — inventory sync; KB layer 14/14 T1/T2 complete)
...
|---|---|---|---|---|
| **T1** | `PUBLIC` | ✅ Yes | ✅ Yes | Framework mechanics, patterns, protocols, agent specs, NDR patterns, governance templates. |
| **T2** | `FRAMEWORK` | ✅ Yes (abstracted) | ✅ Yes (full) | Architectural decisions with implementation rationale. GitHub version is abstracted/summarized. |
| **T3** | `SOVEREIGN` | ❌ No — stub only | ✅ Yes (full) | Njineer-original mathematical formulations, phi-ratio derivations, harmonic alignment proofs, PDMAL-φ agent geometry, Dodecahedral formation topology. |
...
## 20-Agent Taxonomy Index

### Tier 1 — Strategic Quintet (Governance)

| ID | Agent | Role | Classification |
|---|---|---|---|
| A-00 | **Amethyst** | Meta-Orchestrator — 0Hz state-of-states; Logic Bridge anchor | T1 PUBLIC |
| A-01 | **Apogee** | Verification — Gold-Star Alignment Audit; 99.1% Integrity Score gate | T1 PUBLIC |
| A-02 | **Perigee** | Boundary — security filter; Savage Reason (>10Hz) dissonance block | T1 PUBLIC |
| A-03 | **Nova** | Innovation — parallel simulation; 10-year Yggdrasil evolution forecast | T2 FRAMEWORK |
| A-04 | **Professor Prodigy** | Intellectual Catalyst — Phi-Calculus + Reciprocal Mathematics → Micro-Playbook | T1 PUBLIC |

### Tier 2 — Operational Swarm (Tactical, COLLEEN-led)

| ID | Agent | Role | Classification |
|---|---|---|---|
| A-05 | **COLLEEN** | Swarm Lead — Trunk stabilization; archival integrity; BLG surface | T1 PUBLIC |
| A-06 | **The Librarian** | Archive — Provenance Traceability; every decision archived | T1 PUBLIC |
| A-07 | **The Auditor** | QA — 1-min constraint verify; logic collapse prevention | T1 PUBLIC |
| A-08 | **The Actualizer** | Execution — code generation; artifact production | T1 PUBLIC |
| A-09 | **Zenith** | System High — europe-west1 (GCP Pentagonal) load balancing | T2 FRAMEWORK |

### Tier 3 — Schizophonic & Modal Agents (Resonance)

| ID | Agent | Role | Classification |
|---|---|---|---|
| A-10 | **Reson** | Harmonic Coherence — 0.00–1.00 score; ≥0.75 seal threshold | T1 PUBLIC |
| A-11 | **Lyra** | Synthesis / Narrative — Talent Primitive integration; brand voice | T2 FRAMEWORK |
| A-12 | **Echolette** | Pattern Amplification — Signal Chain + Gain Staging metaphor layer | T2 FRAMEWORK |
| A-13 | **Ionia** | Modal Lock — Ionian Harmonic (0Hz) anchor; audit-ready feel | T2 FRAMEWORK |

### T3 SOVEREIGN Extension Agents (PDMAL-φ / Dodecahedral Geometry)

| ID | Agent (stub) | Geometry Layer | Drive Ref |
|---|---|---|---|
| A-14 | [SOV-005 Agent 1] | PDMAL-φ Node 1 | `Drive://DGAF/Sovereign/SOV-005_PDMAL_Taxonomy.md` |
| A-15 | [SOV-005 Agent 2] | PDMAL-φ Node 2 | `Drive://DGAF/Sovereign/SOV-005_PDMAL_Taxonomy.md` |
| A-16 | [SOV-005 Agent 3] | PDMAL-φ Node 3 | `Drive://DGAF/Sovereign/SOV-005_PDMAL_Taxonomy.md` |
| A-17 | [SOV-006 Agent 1] | Dodecahedral Face 1 | `Drive://DGAF/Sovereign/SOV-006_Dodecahedral_Geometry.md` |
| A-18 | [SOV-006 Agent 2] | Dodecahedral Face 2 | `Drive://DGAF/Sovereign/SOV-006_Dodecahedral_Geometry.md` |
| A-19 | [SOV-006 Agent 3] | Dodecahedral Face 3 | `Drive://DGAF/Sovereign/SOV-006_Dodecahedral_Geometry.md` |

> Agent names for A-14 through A-19 are T3 SOVEREIGN. No agent may infer or assign names to these seats.
...
> Full KB stub files for all 14 T1/T2 agents reside in their respective agent subdirectories (`docs/agents/[agent-name]/[AGENT]_KB.md`). The 5 entries above are the PROPRIETARY.md summary layer. T3 agents (A-14→A-19) have no GitHub KB — Drive only.
...
- 20-agent taxonomy index (names + roles + tier only — no formulation content)
...
- PDMAL-φ agent operational logic or node assignments (SOV-005)
- Dodecahedral face-to-agent mapping or inter-agent vector relationships (SOV-006)
- Agent names for A-14 through A-19
...
4. Tag `Classification: T3 SOVEREIGN`
5. If unsure: treat as T3, route to Drive
...
|---|---|---|---|
| BLG-003 | PROPRIETARY.md not established; IP boundary undefined | Phase 3 | 2026-06-28 |
| BLG-006 | 20-agent taxonomy undefined in repo | Phase 4 | 2026-06-29 |

---

## Inventory Impact — KB Layer (Current)

| Agent | ID | KB Status |
|---|---|---|
| Amethyst | A-00 | ✅ `amethyst/` (T1) |
| Apogee | A-01 | ✅ `apogee/` (T1) |
| Perigee | A-02 | ✅ `perigee/` (T1) |
| Nova | A-03 | ✅ `nova/` (T2) |
| Professor Prodigy | A-04 | ✅ `prof-prodigy/` (T1) |
| COLLEEN | A-05 | ✅ `colleen/` (T1) |
| The Librarian | A-06 | ✅ `the-librarian/` (T1) |
| The Auditor | A-07 | ✅ `the-auditor/` (T1) |
| The Actualizer | A-08 | ✅ `the-actualizer/` (T1) |
| Zenith | A-09 | ✅ `zenith/` (T2) |
| Reson | A-10 | ✅ `reson/` (T1) |
| Lyra | A-11 | ✅ `lyra/` (T2) |
| Echolette | A-12 | ✅ `echolette/` (T2) |
| Ionia | A-13 | ✅ `ionia/` (T2) |
| DemiJoule | — | ✅ `demi-joule/` (T1) |
| Sentinel | — | ✅ `sentinel/` (T1) |
| A-14 | A-14 | ❌ T3 SOVEREIGN — Drive only |
| A-15 | A-15 | ❌ T3 SOVEREIGN — Drive only |
| A-16 | A-16 | ❌ T3 SOVEREIGN — Drive only |
| A-17 | A-17 | ❌ T3 SOVEREIGN — Drive only |
| A-18 | A-18 | ❌ T3 SOVEREIGN — Drive only |
| A-19 | A-19 | ❌ T3 SOVEREIGN — Drive only |

**KB layer: 16/16 T1/T2 ✅ COMPLETE. T3: 0/6 (Drive-only by design).**
